...
int zip(llist * ll1, llist * ll2, llist * ll3) {
  ...
  while(ll1->head && ll2->head){
    //the code given during the lab I either totally messed up when I was writing it down or something but it is of no use. it does not operate
    //later figure you why or what is going on.
    //node * tail3 = NULL;
    //if(!tail3){
  ...
  //This code below was what performed the function almost exactly correct except it was mirrored.
    node * n = ll1->head;
   node * next = n->next;
    n->next = ll3->head;
    ll3->head = n;
